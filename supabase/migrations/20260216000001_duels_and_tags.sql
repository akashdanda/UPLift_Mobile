-- ═══════════════════════════════════════════════
-- 1v1 Challenges (Duels) + Workout Tags/Mentions
-- ═══════════════════════════════════════════════
...
-- Counts workouts logged during the duel period for each participant
-- ──────────────────────────────────────────────
...
begin
  ...
  loop
    if d.type = 'workout_count' then
      -- Count workouts in the duel window
      ...
      -- Streak: count consecutive days with workouts from start
...
-- ──────────────────────────────────────────────
-- 3. Function: finalize expired duels (call via cron or client-side)
-- ──────────────────────────────────────────────
